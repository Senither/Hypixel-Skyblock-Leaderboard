        ...
        <section class="hero has-text-centered has-no-background">
            <div class="hero-body">
                <div class="container">
                    ...
                    <h2 class="subtitle">
                        Currently tracking {{ formatNumber(stats.players) }} players with {{ formatNumber(stats.players_metrics) }} metrics!
                    </h2>
                    ...
                    <table class="table is-striped is-hoverable is-fullwidth">
                                ...
                                <th class="is-clickable">
                                    <div class="select is-small">
                                        <select @change="selectCustomSort">
                                            <option v-for="name of Object.keys(sortableColumns)"
                                                :key="name"
                                                :value="name"
                        ...
                        <tbody>
                            <tr v-for="(player, index) of players" @click="clickPlayer(player)">
                                ...
                                <td>
                                    <span class="tag is-success" :class="{
            ...
            loadPlayers() {
                ...
                axios.get(uri).then(response => {
                    ...
                    this.players = response.data.data.map(player => {
                        ...
                        player.last_updated_at_humanized = moment(player.last_updated_at)
                            .toNow()
                            .split(' ')
                            .splice(1)
                            .join(' ') + ' ago';
